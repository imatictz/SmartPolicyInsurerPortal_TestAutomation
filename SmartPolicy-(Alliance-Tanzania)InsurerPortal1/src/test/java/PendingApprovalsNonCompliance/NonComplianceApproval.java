...
public void user_click_on_compliance_quotation_approval_option() throws InterruptedException {
    Itl.CustomClickEvent("//*[@id='MNU_WFFIQNM']", "user click on compliance quotation approval option", "CLICK", 2000);
...
public void user_click_on_display_option() throws InterruptedException {
    Itl.CustomClickEvent("//*[@id='sort_table']/tbody/tr[1]/td[10]/*[1]", "user click on display option", "CLICK", 2000);

}
@Then("user click on update&approve button")
public void user_click_on_update_approve_button() throws InterruptedException {
    Itl.CustomClickEvent("//*[@id='btnUpdate']", "user click on update&approve button", "CLICK", 2000);
...
public void user_navigate_on_screen() throws InterruptedException {
	Itl.CustomValidationEvent("//*[@id='MainContent_label']", "Compliance Quotation Approval", "user navigate on Compliance Quotation Approval screen", "VALIDATION", 0);
}
