...
@edit
Scenario: Verify user able to edit manage bids details successfully
When user enter "VEH4120-02/252" as vehicle number
When user enter "BMW" as vehicle name
...
@delete
Scenario: Verify user able to delete manage bids details successfully
When user enter "VEH4120-02/252" as vehicle number
When user enter "BMW" as vehicle name
When user click on search button
When user click on actions option
...
@approve
Scenario: Verify user able to approve manage bids details successfully
When user enter "VEH4120-02/252" as vehicle number
When user enter "BMW" as vehicle name
When user click on search button
When user click on actions option
